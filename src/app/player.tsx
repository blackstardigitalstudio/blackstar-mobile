...
export default function Player() {
  ...
  // stays open while the app is minimized or the screen locks, the panel sees a
  // second connection when you come back and cuts the feed. So we RELEASE the
  // stream when the app leaves the foreground (frees the server slot immediately —
  // and the app is no longer "quietly still streaming"), then reconnect cleanly on
